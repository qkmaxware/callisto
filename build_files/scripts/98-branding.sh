...
cp -f ctx/files/usr/pixmaps/callisto-logo.png /usr/share/pixmaps/fedora-logo.png
cp -f ctx/files/usr/pixmaps/callisto-logo.svg /usr/share/pixmaps/system-logo-white.png
cp -f ctx/files/usr/pixmaps/callisto-logo.svg /usr/share/pixmaps/fedora-logo-small.png
