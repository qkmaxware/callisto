...
cp ctx/files/usr/share/icons/hicolor/scalable/callisto-logo.svg /usr/share/icons/hicolor/scalable/callisto-logo.svg
...
sed -i 's/^LOGO=.*/LOGO=callisto-logo/' /usr/lib/os-release
